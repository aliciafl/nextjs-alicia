const Footer = () => {
    return (
      <footer className="w-full p-4 pin-b text-center flex flex-col items-center p-4 pin-b">
        <p>Design by Alicia.</p>
